...
public class PullToRefreshRecyclerView extends RecyclerView {
    ...
    public PullToRefreshRecyclerView setCanRefresh(boolean refresh) {
        isCanRefresh = refresh;
        return this;
    }

    public PullToRefreshRecyclerView setCanLoadMore(boolean loadMore) {
    ...
    public PullToRefreshRecyclerView setPullItemAnimator(ItemAnimator animator) {
        setItemAnimator(animator);
        return this;
    }

    public PullToRefreshRecyclerView setHeadRefreshView(AbRefreshHeadView headView) {
        this.mHeadRefreshView = headView;
        return this;
    }

    public PullToRefreshRecyclerView setMoreRefreshView(AbRefreshMoreView moreRefreshView) {
        this.mMoreRefreshView = moreRefreshView;
        return this;
    }

    public PullToRefreshRecyclerView setPullToRefreshListener(PullToRefreshListener pullToRefreshListener) {
        this.pullToRefreshListener = pullToRefreshListener;
        return this;
    }

    public PullToRefreshRecyclerView setPullLayoutManager(LayoutManager layout) {
