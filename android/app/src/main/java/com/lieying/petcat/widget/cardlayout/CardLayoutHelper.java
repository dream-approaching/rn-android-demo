...
import static com.lieying.petcat.widget.cardlayout.ItemTouchHelper.ACTION_STATE_SWIPE;
import static com.lieying.petcat.widget.cardlayout.ItemTouchHelper.ANIMATION_TYPE_SWIPE_CANCEL;
import static com.lieying.petcat.widget.cardlayout.ItemTouchHelper.ANIMATION_TYPE_SWIPE_SUCCESS;
...
public class CardLayoutHelper<T> {
    ...
    public static class Config {
         ...
         * 卡片位置之间的偏移量
         */
        public int offset = ScreenUtils.dip2px(MainApplication.getInstance().getContext() , 8);
    ...
    public LinkedList<T> getmRemovedDataStack() {
        return mRemovedDataStack;
    }
