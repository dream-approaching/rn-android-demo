...
public class TCTimeFragment extends BaseEditFragment implements View.OnClickListener {
    ...
    private NiceImageView mTvCancelSelect, mTvSpeedSelect, mTvRepeatSelect, mTvReverseSelect;
    ...
    private void initWorkLoadingProgress() {
        if (mWorkLoadingProgress == null) {
            mWorkLoadingProgress = VideoWorkProgressFragment.newInstance("视频预处理中...");
    ...
    private void initViews(View view) {
        mTvCancelSelect = (NiceImageView) view.findViewById(R.id.time_tv_cancel_select);
        mTvCancel = (ImageView) view.findViewById(R.id.time_tv_cancel);
        mTvCancel.setOnClickListener(this);
        mTvSpeedSelect = (NiceImageView) view.findViewById(R.id.time_tv_speed_select);
        mTvSpeed = (ImageView) view.findViewById(R.id.time_tv_speed);
        mTvSpeed.setOnClickListener(this);
        mTvSpeed.setSelected(true);
        mTvRepeatSelect = (NiceImageView) view.findViewById(R.id.time_tv_repeat_select);
        mTvRepeat = (ImageView) view.findViewById(R.id.time_tv_repeat);
        mTvRepeat.setOnClickListener(this);
        mTvReverseSelect = (NiceImageView) view.findViewById(R.id.time_tv_reverse_select);
