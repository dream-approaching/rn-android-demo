...
class ReplyNotice extends React.Component {
  ...
  renderHeaderRight = () => {
    ...
    return (
      <TouchableNativeFeedback tapArea={5} onPress={this.handleSubmitReply}>
        ...
        <View style={styles.pageBody}>
          ...
          <View style={styles.replyPersonCon}>
            <Text numberOfLines={2} style={styles.replyPersonText}>
              ...
              <SecondaryText style={styles.replyText}>{itemData.content}</SecondaryText>
            </Text>
          </View>
          {this.renderFooter()}
        </View>
